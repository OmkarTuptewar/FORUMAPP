...
const EditPostModal2 = ({ isOpen, onClose, onSave, initialData }) => {
  ...
  const handleSave = () => {
    const editedData = { _id: initialData._id, title, content, tags, image };
      ...
      <div className="bg-white dark:bg-gray-800 w-full max-w-3xl p-6 rounded-lg shadow-lg mx-4 sm:mx-6 md:mx-8">
        ...
        <div className="flex flex-col sm:flex-row">
          <div className="flex-1 mb-4 sm:mb-0 sm:mr-4">
            ...
            <div className="mb-4">
              <label className={`block text-sm py-1 font-semibold ${isDarkMode ? "text-gray-200" : "text-gray-800"}`}>
                Tags
              </label>
              <Select
                isMulti
